...
class PaypalConfig {
	 ...
	 * <ul>
	 * <li>Real Paypal URL: https://www.paypal.com/fr/cgi-bin/webscr</li>
	 * <li>Real Paypal URL: https://www.sandbox.paypal.com/cgi-bin/webscr</li>
	 * </ul>
	 * 
	 * @var string
	 * @Property
	 ...
	 * 
	 * TODO: VOIR SI ON PEUT PASSER l4UL DANS LES REQUETES!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	 * TODO2: VOIR SI ON PEUT INVITER L'URL comme des grands, en direct!!!!
	 * 
	 * @var string
	 * @Property
	 * @Compulsory
	...
	/**
	 * The webserver URL (without the directory to the application and without trailing slash).
	 * This is used by Paypal to access the IPN.
	 * Therefore, In a development environment, this should not be localhost.
	 * 
	 * @Property
	 * @Compulsory
	 * @var string
	 ...
	 * @return array
	 */
	public function getPaypalArgsArray(PaypalService $paypalService) {
		$paypalArray = array();
		...
		if ($this->webserverUrl !== null) {
			$paypalServiceInstanceName = MoufManager::getMoufManager()->findInstanceName($paypalService);
			$paypalArray["notify_url"] = $this->webserverUrl.ROOT_URL."plugins/modules/paypal/2.0/direct/ipn.php?instance_name=".urlencode($paypalServiceInstanceName);
		}
