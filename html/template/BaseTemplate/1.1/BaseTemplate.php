...
abstract class BaseTemplate implements TemplateInterface, Scopable {
	 ...
	 * If the file url begin with a "/", the file is relative to the base of the web site.
	 * If the file url begin with http or https, the file is out of the web site.
	 * If the file url as no prefix use ROOT_URL as the base Url
	 */
	protected function getCssFiles() {
		...
		if (is_array($this->css_files)) {
			foreach ($this->css_files as $file) {
				...
				$html .= "<link href='".$prefixUrl."$file' rel='stylesheet' type='text/css' />\n";
			}
		}
		return $html;
	}
