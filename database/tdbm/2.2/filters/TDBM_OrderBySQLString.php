...
/**
* The TDBM_OrderBySQLString class translates an ORDER BY [table_name].[column_name] [ASC|DESC] SQL statement.
*
* @Component
* @author David Négrier
*/
class TDBM_OrderBySQLString implements TDBM_OrderByInterface {
	private $sqlString;
