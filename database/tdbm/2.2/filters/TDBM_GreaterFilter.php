...
/**
 * The TDBM_GreaterFilter class translates into an ">" SQL statement.
 * 
 * @Component
...
class TDBM_GreaterFilter implements TDBM_FilterInterface {
	 ...
	 * @param string $value
	 */
	public function TDBM_GreaterFilter($tableName=null, $columnName=null, $value=null) {
		$this->tableName = $tableName;
		$this->columnName = $columnName;
		$this->value = $value;
	}
	...
	public function toSql(DB_ConnectionInterface $dbConnection) {
		...
		if ($this->value === null) {
			throw new TDBM_Exception("Error in TDBM_GreaterFilter: trying to compare $this->tableName.$this->columnName with NULL.");
		}
