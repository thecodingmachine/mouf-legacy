...
class TdbmController extends AbstractMoufInstanceController {
	...
	public function generate($name, $daodirectory, $beandirectory, $daofactoryclassname, $daofactoryinstancename, $selfedit="false") {
		...
		$url = MoufReflectionProxy::getLocalUrlToProject()."plugins/database/tdbm/2.0-alpha/generateDaos.php?name=".urlencode($name)."&selfedit=".$selfedit."&daofactoryclassname=".urlencode($daofactoryclassname)."&daodirectory=".urlencode($daodirectory)."&beandirectory=".urlencode($beandirectory);
