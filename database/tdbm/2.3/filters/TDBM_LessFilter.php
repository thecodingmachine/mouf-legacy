...
/**
 * The TDBM_LessFilter class translates into an "<" SQL statement.
 * 
 * @Component
...
class TDBM_LessFilter implements TDBM_FilterInterface {
	 ...
	 * @param string $value
	 */
	public function TDBM_LessFilter($tableName=null, $columnName=null, $value=null) {
		$this->tableName = $tableName;
		$this->columnName = $columnName;
		$this->value = $value;
	}
	...
	public function toSql(DB_ConnectionInterface $dbConnection) {
		...
		if ($this->value === null) {
			throw new TDBM_Exception("Error in TDBM_LessFilter: trying to compare $this->tableName.$this->columnName with NULL.");
		}
