...
/**
 * The TDBM_DifferentFilter class translates into an "<>" SQL statement (or a "IS NOT NULL" statement if the value to compare is null).
 * 
 * @Component
...
class TDBM_DifferentFilter implements TDBM_FilterInterface {
	 ...
	 * @param string $value
	 */
	public function TDBM_DifferentFilter($tableName=null, $columnName=null, $value=null) {
		$this->tableName = $tableName;
		$this->columnName = $columnName;
		$this->value = $value;
	}
