...
/**
 * The TDBM_NotFilter class translates into an "NOT" SQL statement: it reverses the filter.
 * 
 * @Component
...
class TDBM_NotFilter implements TDBM_FilterInterface {
	 ...
	 * @Property
	 * @Compulsory
	 * @param TDBM_FilterInterface $filter
	 */
	public function setFilter(TDBM_FilterInterface $filter) {
		$this->filter = $filter;
	}
	 ...
	 * @param TDBM_FilterInterface $filter
	 */
	public function TDBM_NotFilter($filter=null) {
		$this->filter = $filter;
	}
