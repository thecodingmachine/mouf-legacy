...
/**
 * The TDBM_BetweenFilter class translates into an "BETWEEN" SQL statement.
 * 
 * @Component
...
class TDBM_BetweenFilter implements TDBM_FilterInterface {
	 ...
	 * @param string $value
	 */
	public function TDBM_BetweenFilter($tableName=null, $columnName=null, $value1=null, $value2=null) {
		$this->tableName = $tableName;
		$this->columnName = $columnName;
		$this->value1 = $value1;
		$this->value2 = $value2;		
