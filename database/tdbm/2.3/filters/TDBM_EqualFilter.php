...
/**
 * The TDBM_EqualFilter class translates into an "=" SQL statement (or a "IS NULL" statement if the value to compare is null).
 * 
 * @Component
...
class TDBM_EqualFilter implements TDBM_FilterInterface {
	 ...
	 * @param string $value
	 */
	public function TDBM_EqualFilter($tableName=null, $columnName=null, $value=null) {
		$this->tableName = $tableName;
		$this->columnName = $columnName;
		$this->value = $value;
	}
