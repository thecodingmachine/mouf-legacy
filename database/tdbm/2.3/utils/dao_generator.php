...
class TDBMDaoGenerator {
	 ...
	 */
	public function __construct(DB_ConnectionInterface $dbConnection, $daoFactoryClassName, $daodirectory, $beandirectory, $support) {
...
class $className extends $baseClassName 
{
	...
	public function generateDao($fileName, $baseFileName, $beanFileName, $className, $baseClassName, $beanClassName, $tableName) {
		...
		$tableCamelInFunction = $this->support ? $tableCamel : "";
...
class $baseClassName implements DAOInterface
{
	 ...
	 */
	public function " . (!$this->support ? "create" : "getNew$tableCamel") . "() {
	 ...
	 *
	 */
	public function save$tableCamelInFunction(\$obj) {
		\$obj->save();
	}
	 ...
	 */
	public function get".$tableCamelInFunction."List() {
	 ...
	 */
	public function get".$tableCamelInFunction."ById(\$id, \$lazyLoading = false) {
	 ...
	 */
	public function delete".$tableCamelInFunction."(\$obj) {
	 ...
	 * @return array<$beanClassName>
	 */
	protected function get".$tableCamelInFunction."ListByFilter(\$filterBag=null, \$orderbyBag=null, \$from=null, \$limit=null) {
	 ...
	 * @return $beanClassName
	 */
	protected function get".$tableCamelInFunction."ByFilter(\$filterBag=null) {
