...
class TdbmController extends AbstractMoufInstanceController {
	...
	public static function generateDaos($moufManager, $name, $daodirectory, $beandirectory, $daofactoryclassname, $daofactoryinstancename, $selfedit="false") {
		...
		$url = MoufReflectionProxy::getLocalUrlToProject()."plugins/database/tdbm/2.1/generateDaos.php?name=".urlencode($name)."&selfedit=".$selfedit."&daofactoryclassname=".urlencode($daofactoryclassname)."&daodirectory=".urlencode($daodirectory)."&beandirectory=".urlencode($beandirectory);
