...
MoufUtils::registerMenuItem('utilsAdvancedLoggerViewStats2MenuItem', 'View log stats', 'javascript:chooseInstancePopup("AdvancedMailLogger", "'.ROOT_URL.'mouf/advancedlogger/showStats?name=")', 'utilsAdvencedMailLoggerSubMenu', 10);
