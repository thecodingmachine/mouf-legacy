 ...
 */
abstract class AbstractFilter extends stubAbstractAnnotation implements stubAnnotation
{
	/**
	 ...
	 */
	public function setMetaData(Controller $controller, stubReflectionMethod $refMethod) {
