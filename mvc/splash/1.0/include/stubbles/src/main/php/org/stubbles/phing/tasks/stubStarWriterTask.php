...
/**
 * Uses stubbles star classes
 */
require_once 'lib/starWriter.php';
/**
 * Task to create star files.
 *
 * @package     stubbles
 * @subpackage  phing_tasks
 */
class stubStarWriterTask extends Task
{
    /**
    ...
    public function main()
    {
        ...
        $starArchive = new StarArchive(new StarWriter($this->buildPath), $this->starVersion);
        ...
        $starArchive->addMetaData('copyright', '(c) 2007-' . date('Y') . ' ' . $this->copyright);
        $starArchive->create();
    }
