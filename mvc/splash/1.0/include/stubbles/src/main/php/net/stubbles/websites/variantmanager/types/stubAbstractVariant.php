 ...
 * 
 * Implements functionality that is shared and does
 * not influence variant selection algorithms.
 * 
 * @author      Niels Schelbach <niels@schlund.de>
 * @author      Stephan Schmidt <stephan.schmidt@schlund.de>
 * @author      Carsten Hemstädter <carsten.helmstaedter@schlund.de>
