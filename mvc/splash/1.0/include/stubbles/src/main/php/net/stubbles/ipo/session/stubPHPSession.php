...
class stubPHPSession extends stubAbstractSession
{
    ...
    {
        $encoder = new stubMd5Encoder('', stubRegistry::getConfig(stubSession::SALT_REGISTRY_KEY, ''));
        return $encoder->encode($this->request->getValidatedValue(new stubPassThruValidator(), 'HTTP_USER_AGENT', stubRequest::SOURCE_HEADER));
    }
