<?php
/**
 * Test for net::stubbles::websites::variantmanager::types::stubRandomVariant.
 *
 * @author      Frank Kleine <mikey@stubbles.net>
 * @package     stubbles
 * @subpackage  websites_variantmanager_test
 */
stubClassLoader::load('net::stubbles::websites::variantmanager::types::stubRandomVariant',
