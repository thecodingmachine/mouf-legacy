...
class stubReflectionParameterTestCase extends PHPUnit_Framework_TestCase
{
    ...
    public function annotations()
    {
        ...
        $this->assertType('stubParamAnnoAnnotation', $this->stubRefParamFunction->getAnnotation('ParamAnno'));
        $this->assertTrue($this->stubRefParamMethod1->hasAnnotation('ParamAnno'));
        $this->assertType('stubParamAnnoAnnotation', $this->stubRefParamMethod1->getAnnotation('ParamAnno'));
        $this->assertTrue($this->stubRefParamMethod2->hasAnnotation('ParamAnno'));
        $this->assertType('stubParamAnnoAnnotation', $this->stubRefParamMethod2->getAnnotation('ParamAnno'));
        $this->assertTrue($this->stubRefParamMethod3->hasAnnotation('ParamAnno'));
        $this->assertType('stubParamAnnoAnnotation', $this->stubRefParamMethod3->getAnnotation('ParamAnno'));
