<?php
/**
 * Test for net::stubbles::websites::variantmanager::stubVariantsMap.
 *
 ...
 */
stubClassLoader::load('net::stubbles::websites::variantmanager::stubVariantsMap',
                      'net::stubbles::websites::variantmanager::types::stubLeadVariant',
                      'net::stubbles::websites::variantmanager::types::stubRequestParamVariant'
);
/**
...
class stubVariantsMapTestCase extends PHPUnit_Framework_TestCase
{
    ...
    public function getVariantNames()
    {
        ...
        $this->assertEquals(array('v1', 'v2', 'v3'), $this->variantMap->getVariantNames());
    }
    ...
    public function withRootArgument()
    {
        ...
        $this->assertEquals(array('v1', 'v2', 'v3'), $variantMap->getVariantNames());
