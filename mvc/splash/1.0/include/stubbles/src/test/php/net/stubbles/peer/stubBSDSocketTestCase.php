...
class stubBSDSocketTestCase extends PHPUnit_Framework_TestCase
{
    ...
    {
        $socket = new stubBSDSocket('example.com', 21);
        $this->assertEquals('example.com', $socket->getHost());
