...
class stubInjectorBasicTestCase extends PHPUnit_Framework_TestCase
{
    ...
    public function constructorInjection()
    {
        ...
        $this->assertType('stubInjectorTestCase_Vehicle', $vehicle);
        $this->assertType('stubInjectorTestCase_Car', $vehicle);
        $this->assertType('stubInjectorTestCase_Tire', $vehicle->tire);
        $this->assertType('stubInjectorTestCase_Goodyear', $vehicle->tire);
    }
    ...
    public function setterInjection()
    {
        ...
        $this->assertType('stubInjectorTestCase_Vehicle', $vehicle);
        $this->assertType('stubInjectorTestCase_Bike', $vehicle);
        $this->assertType('stubInjectorTestCase_Tire', $vehicle->tire);
        $this->assertType('stubInjectorTestCase_Goodyear', $vehicle->tire);
    }
    ...
    public function optionalSetterInjection()
    {
        ...
        $this->assertType('stubInjectorTestCase_Vehicle', $vehicle);
        $this->assertType('stubInjectorTestCase_Convertible', $vehicle);
    ...
    public function implicitBinding()
    {
        ...
        $this->assertType('stubInjectorTestCase_Goodyear', $goodyear);
    }
    ...
    public function implicitBindingAsDependency()
    {
        ...
        $this->assertType('stubInjectorTestCase_ImplicitDependency', $obj);
        $this->assertType('stubInjectorTestCase_Goodyear', $obj->getGoodyearByConstructor());
        $this->assertType('stubInjectorTestCase_Goodyear', $obj->getGoodyearBySetter());
    }
