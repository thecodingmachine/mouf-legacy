 ...
 */';
    ...
    public function create()
    {
        ...
        $this->assertType('MyAnnotation', $myAnnotation);
        ...
        $this->assertType('AnotherAnnotation', $anotherAnnotation);
        $this->assertEquals('true', $anotherAnnotation->value);
        ...
        $this->assertType('EmptyAnnotation', $emptyAnnotation);
        ...
        $this->assertType('AnotherAnnotation', $castedAnnotation);
        ...
        $this->assertType('MyAnnotation', $myAnnotation);
        $this->assertType('stubReflectionClass', $myAnnotation->foo);
    }
    ...
    public function createForArgument()
    {
        ...
        $this->assertType('AnotherAnnotation', $emptyAnnotation);
    ...
    public function cache()
    {
        ...
        $this->assertType('MyAnnotation', $anno);
        $this->assertEquals('bar', $anno->foo);
        $this->assertEquals('true', $anno->argh);
        ...
        $this->assertType('MyAnnotation', $anno2);
        $this->assertEquals('bar', $anno2->foo);
        $this->assertEquals('true', $anno2->argh);
        ...
        $this->assertEquals('true', $anno3->argh);
