...
class stubFirebugLoggerTestCase extends PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $headers['100000000001']     = '{';
        $headersDump['200000000001'] = '"FirePHP.Dump":{';
        $headersDump['299999999999'] = '"__SKIP__":"__SKIP__"},';
        $headersLog['300000000001']  = '"FirePHP.Firebug.Console":[';
        $headersLog['399999999999']  = '["__SKIP__"]],';
        $headers['999999999999']     = '"__SKIP__":"__SKIP__"}';

        $this->headersSpecLog = array_merge(array_merge($headers, $headersLog));
        ksort($this->headersSpecLog);

        $this->headersSpecDump = array_merge(array_merge($headers, $headersDump));
