<?php
/**
 * Integration test for request value errors defined in xml.
 *
 ...
 * @group       integration
 */
class stubRequestValueErrorXJConfFactoryTestCase extends PHPUnit_Framework_TestCase
{
    /**
    ...
    public function all()
    {
        $rveFactory = new stubRequestValueErrorXJConfFactory();
        ...
        stubRequestValueErrorXJConfFactory::refresh();
        // cached
        $rveFactory = new stubRequestValueErrorXJConfFactory();
        $this->FIELD_EMPTY($rveFactory);
        $this->FIELD_NO_SELECT($rveFactory);
    ...
    public function FIELD_EMPTY($rveFactory)
    {
        ...
        $this->assertType('stubRequestValueError', $requestError);
