<?php
/**
 * Test for net::stubbles::streams::memory::stubMemoryStreamWrapper.
 *
 * @author      Frank Kleine mikey@stubbles.net
 * @package     stubbles
 * @subpackage  streams_memory_test
 */
stubClassLoader::load('net::stubbles::streams::memory::stubMemoryStreamWrapper');
/**
 * Test for net::stubbles::streams::memory::stubMemoryStreamWrapper.
 *
 * @package     stubbles
 ...
 */
class stubMemoryStreamWrapperTestCase extends PHPUnit_Framework_TestCase
{
    /**
     * url of test stream
     *
