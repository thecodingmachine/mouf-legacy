 ...
 * @version     $Id: stubRSSFeedItemAnnotationTestCase.php 1830 2008-09-17 14:29:14Z mikey $
 */
stubClassLoader::load('net::stubbles::xml::rss::stubRSSFeedItemAnnotation',
                      'net::stubbles::xml::rss::stubRSSFeedGenerator'
);
/**
