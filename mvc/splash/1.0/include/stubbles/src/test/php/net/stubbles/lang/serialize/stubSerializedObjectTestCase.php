...
class stubSerializedObjectTestCase extends PHPUnit_Framework_TestCase
{
    ...
    public function unserialize()
    {
        ...
        $this->assertType('stub3stubSerializableObject', $restored);
    ...
    /**
     * assure that serialization throws an exception
     *
     * @test
    ...
    public function serializationIntegrity()
    {
        ...
        $this->assertType('stub3stubSerializableObject', $serializableObject);
