...
class stubReflectionObjectTestCase extends PHPUnit_Framework_TestCase
{
    ...
    public function getConstructor()
    {
        ...
        $this->assertType('stubReflectionMethod', $stubRefMethod);
    ...
    public function getMethodsByMatcher()
    {
        ...
        $this->assertType('stubReflectionMethod', $stubRefMethods[0]);
    }
    ...
    public function getProperty()
    {
        ...
        $this->assertType('stubReflectionProperty', $stubRefProperty);
    ...
    public function getPropertiesByMatcher()
    {
        ...
        $this->assertType('stubReflectionProperty', $stubRefProperties[0]);
    }
    ...
    public function getInterfaces()
    {
        ...
        foreach ($stubRefClasses as $stubRefClass) {
            $this->assertType('stubReflectionClass', $stubRefClass);
    ...
    public function getExtension()
    {
        ...
        $this->assertType('stubReflectionExtension', $refClass->getExtension());
    }
    ...
    public function getPackage()
    {
        ...
        $this->assertType('stubReflectionPackage', $package);
    }
