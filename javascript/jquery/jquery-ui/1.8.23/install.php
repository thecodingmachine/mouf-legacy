...
$jQueryUILib->getProperty("jsFiles")->setValue(array(
	'plugins/javascript/jquery/jquery-ui/1.8.23/js/jquery-ui-1.8.23.custom.min.js'
));
$jQueryUILib->getProperty("cssFiles")->setValue(array(
	'plugins/javascript/jquery/jquery-ui/1.8.23/css/ui-darkness/jquery-ui-1.8.23.custom.css'
));
