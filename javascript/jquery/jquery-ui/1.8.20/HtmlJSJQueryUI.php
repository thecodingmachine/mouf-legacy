...
class HtmlJSJQueryUI implements HtmlElementInterface {
	...
	public function toHtml() {
		if ($this->includeDefaultCss) {
			echo '<link type="text/css" href="'.ROOT_URL.'plugins/javascript/jquery/jquery-ui/1.8.20/css/'.$this->includeDefaultCss.'/jquery-ui-1.8.20.custom.css" rel="stylesheet" media="screen" />'."\n";
		}
		echo '<script type="text/javascript" src="'.ROOT_URL.'plugins/javascript/jquery/jquery-ui/1.8.20/js/jquery-ui-1.8.20.custom.min.js"></script>';
