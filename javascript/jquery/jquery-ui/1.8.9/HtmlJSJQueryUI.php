...
class HtmlJSJQueryUI implements HtmlElementInterface {
	 ...
	 * @OneOfText "ui-lightness", "ui-darknes", "black-tie", "blitzer", "cupertino", "dark-hive", "dot-luv", "eggplant", "excite-bike", "flick", "hot-sneaks", "humanity", "le-frog", "mint-choc", "overcast", "pepper-grinder", "redmond", "smoothness", "south-street", "start", "sunny", "swanky-purse", "trontastic", "vader"
	 * @var string
	 */
	...
	public function toHtml() {
		...
		echo '<script type="text/javascript" src="'.ROOT_URL.'plugins/javascript/jquery/jquery-ui/1.8.9/js/jquery-ui-1.8.9.custom.min.js"></script>';
